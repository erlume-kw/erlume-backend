...
const OutfitSchema = new mongoose_1.Schema({
    item_ids: [
        { type: mongoose_1.Schema.Types.ObjectId, ref: "Item", required: true, index: true },
    ],
...
OutfitSchema.pre("findOneAndDelete", function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (doc) {
            yield OutfitItem_1.default.deleteMany({ outfit_id: doc._id });
        }
        next();
    });
});
const Outfit = mongoose_1.default.model("Outfit", OutfitSchema);
